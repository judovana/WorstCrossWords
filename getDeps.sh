...
if [ "x$CONTAINER_BUILD" == "xTrue" ] ; then
  ...
  echo "1: empty one, where you have to mount local cache, as -v=your_local_dir_with_ai_cahe:/home/game/WorstCrossWords/cache"
  echo "eg  -v=./cache:/home/game/WorstCrossWords/cache"
  echo "Where youc an download some caches from releases"
  ...
  echo "primarily 'game.py lang/filee_to_play_with' of course"
...
" > full
    ...
    echo "RUN ls -l /home/game/WorstCrossWords/cache/" >> full
